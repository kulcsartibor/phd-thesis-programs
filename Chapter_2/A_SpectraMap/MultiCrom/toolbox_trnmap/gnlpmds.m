function [w,C,z, Esz] = gnlpmds(X,tmax,n,epszi,epszf,Ti,Tf,lambdai,lambdaf, alfai, alfaf, deltai, deltaf,K,z)
...
%step1
[w,C] = nglearning(X,200*n,n,epszi,epszf,Ti,Tf,lambdai,lambdaf,K);
[C]=conn(w,C);
cd_geo=geo_dist(w,C);
[z,stress] = mdscale(cd_geo,2,'criterion','stress');
z=z';
