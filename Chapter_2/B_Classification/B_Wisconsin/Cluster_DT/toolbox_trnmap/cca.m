function [P] = cca(D, P, epochs, Mdist, alfa0, lambda0)
...
% P = cca(D, pca(D,2), 5); %does the same, but with PCA initialization
% P = cca(D, 2, 10, Mdist); %same, but mutual distance matrix is given
%
% See also SAMMON, PCA, SOM_GRID. 
...
% calculate error
error_a = cca_error(P,Mdist,lambda(train_len));
