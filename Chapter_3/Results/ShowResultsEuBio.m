...
[Mt,Mc,V,U] = trustcont(10, X, PLSPoints1, DistM, L2_distance(PLSPoints1',PLSPoints1'));
Mt*Mc
figure('Color', [1 1 1])
subplot(1,2,1)
...
[Mt,Mc,V,U] = trustcont(10, X, PLSPoints2, DistM, L2_distance(PLSPoints2',PLSPoints2'));
Mt*Mc
subplot(1,2,2)
