...
vist = PrintTable;
vist.Format = 'tex';
vist.addRow('Method','$M_{t}$','$M_{c}$','Metric Error','FNN (Density)', 'FNN (Reflect)')
reft = PrintTable;
reft.Format = 'tex';
reft.addRow('Regression Method', 'CorrCoef (Density)', 'CorrCoef (Reflect)')
advt = PrintTable;
advt.Format = 'tex';
advt.addRow('Regression Method', 'CorrCoef (Density)', 'CorrCoef (Reflect)')
...
for k = 5:15
	...
	advt.addRow(['PLS (Spect, ' num2str(k) ' latent var.)'], num2str(cr1(2)), num2str(cr2(2)))
end
