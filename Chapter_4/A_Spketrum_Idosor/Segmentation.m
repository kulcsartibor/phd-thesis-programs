...
fastsumbuffer = computeBuffer(X,degree)
...
[R,P,D] = getCostDegreeSegmentation(X,k,0,degree,0)
...
global tags;
tags = {{computeSquaredFitError(fastsumbuffer,0+1,length(X)+1,degreemin),{0,length(X),degreemin}}};
...
verbose = 1;
answer_error = solveTopDownSegmentationHeuristic1(X, k, verbose);
