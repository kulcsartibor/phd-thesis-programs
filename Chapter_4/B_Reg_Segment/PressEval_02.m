...
%%
figure('Name','PLS 5 látens változóval','NumberTitle','off', 'Color',[1 1 1]);
plsm = pls(X,Y,5);
plot(Y,plsm.Ypc,'+','MarkerSize',1)
axis([0 1 0 1])
line([0 1],[0 1],'Color',[0 0 0],'LineWidth',2)
...
%%
figure('Name','PLS 5 látens változóval','NumberTitle','off', 'Color',[1 1 1]);
index = find((Y-plsm.Ypc) < -0.1);
plot(cmprsm.tw1,cmprsm.tw2,'+','MarkerSize',1)
hold on
plot(cmprsm.tw1(index),cmprsm.tw2(index),'r+','MarkerSize',3)
axis('square')
xlabel('Laten dim 1','Interpreter','latex','FontSize',12)
ylabel('Laten dim 2','Interpreter','latex','FontSize',12)


%%
figure
subplot(3,1,1)
plot(T,cmprsm.tw1,'+','MarkerSize',1)
subplot(3,1,2)
plot(T,cmprsm.tw2,'+','MarkerSize',1)
subplot(3,1,3)
plot(T,Y-plsm.Ypc,'+','MarkerSize',1)
