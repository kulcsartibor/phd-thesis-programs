...
DelI = union(DelI,find(ismember(XVars(3,:),'3BARGOZ BELEPO')));
DelI = union(DelI,find(ismember(XVars(3,:),'11BARGOZ BELEPO')));
DelI = union(DelI,find(ismember(XVars(3,:),'3BARGOZ BELEPO TO-H')));
DelI = union(DelI,find(ismember(XVars(3,:),'11BARGOZ BELEPO TO-H')));
% DelI = union(DelI,find(ismember(XVars(3,:),'')));
% DelI = union(DelI,find(ismember(XVars(3,:),'')));

% DelI = union(DelI,find(ismember(XVars(3,:),'301/1 1.TEKERCS HOMERS.')));
