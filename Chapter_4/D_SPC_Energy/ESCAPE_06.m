...
axis square
grid on
title('Heating~Steam $(Linear~model)$','Interpreter','LaTeX','FontSize',18)
box on
...
xlabel('Number of input variables for PLS','Interpreter','LaTeX','FontSize',18)
...
ylabel('Error $(Linear~model)$','Interpreter','LaTeX','FontSize',14)
ylim([-20 20])
hline(0,'k--')
